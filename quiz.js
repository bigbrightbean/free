...
var questions = [
    ...
    },
    {
        ...
        chinese_question: "在学年结束时，教师们常常被 __________ 的文书工作压得喘不过气来。",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "unleash", chinese_answer: "释放", chinese_romanization: "shìfàng" },
        ...
        explanation: "(C) 'check' means to control or restrain." +
            "<br><br>" +
            "(A) 'unleash' means to release from a leash or restraint." +
            "<br><br>" +
